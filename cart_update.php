...
if(isset($_POST["type"]) && $_POST["type"]=='add')
{
	...
	$results =mysql_query("SELECT name as nams,price FROM ms_barang WHERE id='$product_code' LIMIT 1");
...
{ 
		...
		$new_product = array(array('name'=>$nama, 'code'=>$product_code, 'qty'=>$product_qty, 'price'=>$price));
